...
export class LayoutNavbar extends CustomElement {
  ...
  constructor() {
    ...
    this._update_url = "https://github.com/ghaction/nas-2.9";
      ...
      if (ret.code === 0) {
        ...
        switch (compareVersion(ret.version, this.layout_appversion)) {
          case 1:
            ...
            break;
          case 2:
            url = "https://github.com/ghaction/nas-2.9/commits/master";
            break;
        }
        if (url) {
              ...
              <div class="d-flex align-items-end">
                ...
                >
                  <a
                    ...
                    class="${this._is_update ? "text-yellow-fg" : "text-muted"}"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <strong>
                      ...
                      ${!this._is_update
                        ...
                        : html`<del>${this.layout_appversion}</del>`}
                    </strong>
                  </a>
                  ${this._is_update
                    ? html` <svg
